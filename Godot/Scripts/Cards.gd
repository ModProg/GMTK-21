...
func _highlight_card() -> void:
	if detecting_mouse:
		tween.interpolate_property(self, "rect_position", self.rect_position, self.rect_position - Vector2(0, 150), 0.25, Tween.TRANS_LINEAR, Tween.EASE_OUT_IN)
		tween.interpolate_property(self, "rect_scale", self.rect_scale, self.rect_scale + Vector2(0.25, 0.25), 0.25, Tween.TRANS_LINEAR, Tween.EASE_OUT_IN)
		tween.start()
...
func _play_down() -> void:
	...
	tween.interpolate_property(self, "rect_scale", self.rect_scale, Vector2(1, 1), 0.25, Tween.TRANS_LINEAR, Tween.EASE_OUT_IN)
	tween.start()
